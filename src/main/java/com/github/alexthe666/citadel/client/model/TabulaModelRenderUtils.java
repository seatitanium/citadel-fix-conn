...
public class TabulaModelRenderUtils {
   ...
   public static class ModelBox {
      ...
      public ModelBox(
         ...
         TabulaModelRenderUtils.PositionTextureVertex lvt_18_2_ = new TabulaModelRenderUtils.PositionTextureVertex(
            p_i225950_3_, p_i225950_4_, p_i225950_5_, 0.0F, 0.0F
         );
         TabulaModelRenderUtils.PositionTextureVertex lvt_19_1_ = new TabulaModelRenderUtils.PositionTextureVertex(
            lvt_15_1_, p_i225950_4_, p_i225950_5_, 0.0F, 8.0F
         );
         TabulaModelRenderUtils.PositionTextureVertex lvt_20_1_ = new TabulaModelRenderUtils.PositionTextureVertex(
            lvt_15_1_, lvt_16_1_, p_i225950_5_, 8.0F, 8.0F
         );
         TabulaModelRenderUtils.PositionTextureVertex lvt_21_1_ = new TabulaModelRenderUtils.PositionTextureVertex(
            p_i225950_3_, lvt_16_1_, p_i225950_5_, 8.0F, 0.0F
         );
         TabulaModelRenderUtils.PositionTextureVertex lvt_22_1_ = new TabulaModelRenderUtils.PositionTextureVertex(
            p_i225950_3_, p_i225950_4_, lvt_17_1_, 0.0F, 0.0F
         );
         TabulaModelRenderUtils.PositionTextureVertex lvt_23_1_ = new TabulaModelRenderUtils.PositionTextureVertex(
            lvt_15_1_, p_i225950_4_, lvt_17_1_, 0.0F, 8.0F
         );
         ...
         TabulaModelRenderUtils.PositionTextureVertex lvt_25_1_ = new TabulaModelRenderUtils.PositionTextureVertex(
            p_i225950_3_, lvt_16_1_, lvt_17_1_, 8.0F, 0.0F
         );
         ...
         this.quads[2] = new TabulaModelRenderUtils.TexturedQuad(
            new TabulaModelRenderUtils.PositionTextureVertex[]{lvt_23_1_, lvt_22_1_, lvt_18_2_, lvt_19_1_},
            lvt_27_1_,
            lvt_32_1_,
            lvt_28_1_,
            lvt_33_1_,
         ...
         this.quads[3] = new TabulaModelRenderUtils.TexturedQuad(
            new TabulaModelRenderUtils.PositionTextureVertex[]{lvt_20_1_, lvt_21_1_, lvt_25_1_, lvt_24_1_},
            lvt_28_1_,
            lvt_33_1_,
            lvt_29_1_,
            lvt_32_1_,
         ...
         this.quads[1] = new TabulaModelRenderUtils.TexturedQuad(
            new TabulaModelRenderUtils.PositionTextureVertex[]{lvt_18_2_, lvt_22_1_, lvt_25_1_, lvt_21_1_},
            lvt_26_1_,
            lvt_33_1_,
            lvt_27_1_,
            lvt_34_1_,
         ...
         this.quads[4] = new TabulaModelRenderUtils.TexturedQuad(
            new TabulaModelRenderUtils.PositionTextureVertex[]{lvt_19_1_, lvt_18_2_, lvt_21_1_, lvt_20_1_},
            lvt_27_1_,
            lvt_33_1_,
            lvt_28_1_,
            lvt_34_1_,
         ...
         this.quads[0] = new TabulaModelRenderUtils.TexturedQuad(
            new TabulaModelRenderUtils.PositionTextureVertex[]{lvt_23_1_, lvt_19_1_, lvt_20_1_, lvt_24_1_},
            lvt_28_1_,
            lvt_33_1_,
            lvt_30_1_,
            lvt_34_1_,
         ...
         this.quads[5] = new TabulaModelRenderUtils.TexturedQuad(
            new TabulaModelRenderUtils.PositionTextureVertex[]{lvt_22_1_, lvt_23_1_, lvt_24_1_, lvt_25_1_},
            lvt_30_1_,
            lvt_33_1_,
            lvt_31_1_,
            lvt_34_1_,
   ...
   static class TexturedQuad {
      ...
      public TexturedQuad(
         TabulaModelRenderUtils.PositionTextureVertex[] p_i225951_1_,
         float p_i225951_2_,
         float p_i225951_3_,
         float p_i225951_4_,
         float p_i225951_5_,
         float p_i225951_6_,
         float p_i225951_7_,
         boolean p_i225951_8_,
         Direction p_i225951_9_
      ) {
