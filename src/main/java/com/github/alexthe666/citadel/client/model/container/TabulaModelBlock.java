...
public class TabulaModelBlock {
   ...
   static final Gson SERIALIZER = new GsonBuilder()
      ...
      .registerTypeAdapter(BlockElement.class, new net.minecraft.client.renderer.block.model.BlockElement.Deserializer())
      .registerTypeAdapter(BlockElementFace.class, new net.minecraft.client.renderer.block.model.BlockElementFace.Deserializer())
      .registerTypeAdapter(BlockFaceUV.class, new net.minecraft.client.renderer.block.model.BlockFaceUV.Deserializer())
      .registerTypeAdapter(ItemTransform.class, new net.minecraft.client.renderer.block.model.ItemTransform.Deserializer())
      .registerTypeAdapter(ItemTransforms.class, new net.minecraft.client.renderer.block.model.ItemTransforms.Deserializer())
      .registerTypeAdapter(ItemOverride.class, new net.minecraft.client.renderer.block.model.ItemOverride.Deserializer())
      .create();
   ...
   public TabulaModelBlock(
      ...
      boolean gui3dIn,
      ItemTransforms cameraTransformsIn,
   ...
   public ItemTransforms getAllTransforms() {
      ItemTransform itemtransformvec3f = this.getTransform(TransformType.THIRD_PERSON_LEFT_HAND);
      ItemTransform itemtransformvec3f1 = this.getTransform(TransformType.THIRD_PERSON_RIGHT_HAND);
      ItemTransform itemtransformvec3f2 = this.getTransform(TransformType.FIRST_PERSON_LEFT_HAND);
      ItemTransform itemtransformvec3f3 = this.getTransform(TransformType.FIRST_PERSON_RIGHT_HAND);
      ItemTransform itemtransformvec3f4 = this.getTransform(TransformType.HEAD);
      ItemTransform itemtransformvec3f5 = this.getTransform(TransformType.GUI);
      ItemTransform itemtransformvec3f6 = this.getTransform(TransformType.GROUND);
      ItemTransform itemtransformvec3f7 = this.getTransform(TransformType.FIXED);
   ...
   private ItemTransform getTransform(TransformType type) {
