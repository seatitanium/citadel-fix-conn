...
public class BasicModelPart {
   ...
   private void addBox(
      ...
      this.cubeList
         .add(
            new BasicModelPart.ModelBox(texOffX, texOffY, x, y, z, width, height, depth, deltaX, deltaY, deltaZ, mirorIn, this.textureWidth, this.textureHeight)
         );
   }
   ...
   public void render(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
      if (this.showModel && (!this.cubeList.isEmpty() || !this.childModels.isEmpty())) {
         ...
         while (var9.hasNext()) {
            BasicModelPart BasicModelPart = (BasicModelPart)var9.next();
   ...
   private void doRender(Pose matrixEntryIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
      ...
      while (var11.hasNext()) {
         BasicModelPart.ModelBox BasicModelPart$modelbox = (BasicModelPart.ModelBox)var11.next();
         ...
         for (BasicModelPart.TexturedQuad BasicModelPart$texturedquad : BasicModelPart$modelbox.quads) {
            ...
            for (int i = 0; i < 4; i++) {
               ...
               bufferIn.vertex(
                  ...
                  blue,
                  alpha,
                  BasicModelPart$positiontexturevertex.textureU,
                  BasicModelPart$positiontexturevertex.textureV,
                  packedOverlayIn,
                  packedLightIn,
                  f,
                  f1,
   ...
   public BasicModelPart.ModelBox getRandomCube(Random randomIn) {
      return (BasicModelPart.ModelBox)this.cubeList.get(randomIn.nextInt(this.cubeList.size()));
   }
   ...
   public static class ModelBox {
      ...
      public ModelBox(
         ...
         this.quads[2] = new BasicModelPart.TexturedQuad(
            new BasicModelPart.PositionTextureVertex[]{
               BasicModelPart$positiontexturevertex4,
               BasicModelPart$positiontexturevertex3,
               BasicModelPart$positiontexturevertex7,
         ...
         this.quads[3] = new BasicModelPart.TexturedQuad(
            new BasicModelPart.PositionTextureVertex[]{
               BasicModelPart$positiontexturevertex1,
               BasicModelPart$positiontexturevertex2,
               BasicModelPart$positiontexturevertex6,
               BasicModelPart$positiontexturevertex5
            },
            f6,
            f11,
            f7,
         ...
         this.quads[1] = new BasicModelPart.TexturedQuad(
            new BasicModelPart.PositionTextureVertex[]{
               BasicModelPart$positiontexturevertex7,
               BasicModelPart$positiontexturevertex3,
               BasicModelPart$positiontexturevertex6,
         ...
         this.quads[4] = new BasicModelPart.TexturedQuad(
            new BasicModelPart.PositionTextureVertex[]{
               BasicModelPart$positiontexturevertex,
               BasicModelPart$positiontexturevertex7,
               BasicModelPart$positiontexturevertex2,
   ...
   static class TexturedQuad {
      ...
      public TexturedQuad(
         BasicModelPart.PositionTextureVertex[] positionsIn,
         float u1,
         float v1,
         float u2,
         float v2,
