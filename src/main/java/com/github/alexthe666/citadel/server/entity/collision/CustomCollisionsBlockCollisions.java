...
public class CustomCollisionsBlockCollisions extends AbstractIterator<VoxelShape> {
   ...
   public CustomCollisionsBlockCollisions(CollisionGetter p_186406_, @Nullable Entity p_186407_, AABB p_186408_, boolean p_186409_) {
      ...
      int i = Mth.floor(p_186408_.minX - 1.0E-7) - 1;
      int j = Mth.floor(p_186408_.maxX + 1.0E-7) + 1;
      int k = Mth.floor(p_186408_.minY - 1.0E-7) - 1;
      int l = Mth.floor(p_186408_.maxY + 1.0E-7) + 1;
      int i1 = Mth.floor(p_186408_.minZ - 1.0E-7) - 1;
      int j1 = Mth.floor(p_186408_.maxZ + 1.0E-7) + 1;
