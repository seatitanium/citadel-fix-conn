...
public class CustomCollisionsNodeProcessor extends WalkNodeEvaluator {
   public static BlockPathTypes getBlockPathTypeStatic(BlockGetter p_237231_0_, MutableBlockPos p_237231_1_) {
      ...
      if (pathnodetype == BlockPathTypes.OPEN && j >= 1) {
         ...
         pathnodetype = pathnodetype1 != BlockPathTypes.WALKABLE
               && pathnodetype1 != BlockPathTypes.OPEN
               && pathnodetype1 != BlockPathTypes.WATER
               && pathnodetype1 != BlockPathTypes.LAVA
   ...
   protected static BlockPathTypes getNodes(BlockGetter p_237238_0_, BlockPos p_237238_1_) {
      ...
      if (type != null) {
         ...
         if (blockstate.isAir()) {
            ...
            return blockstate.getBlock() == Blocks.BAMBOO ? BlockPathTypes.OPEN : getBlockPathTypeRaw(p_237238_0_, p_237238_1_);
         }
      }
   }

   public BlockPathTypes getBlockPathType(BlockGetter blockaccessIn, int x, int y, int z) {
      return getBlockPathTypeStatic(blockaccessIn, new MutableBlockPos(x, y, z));
   }
   ...
   protected BlockPathTypes evaluateBlockPathType(BlockGetter world, boolean b1, boolean b2, BlockPos pos, BlockPathTypes nodeType) {
      ...
      return ((ICustomCollisions)this.mob).canPassThrough(pos, state, state.getBlockSupportShape(world, pos))
         ? BlockPathTypes.OPEN
         : super.evaluateBlockPathType(world, b1, b2, pos, nodeType);
   }
}
